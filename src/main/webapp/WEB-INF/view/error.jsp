...
<HTML><HEAD><TITLE>Sorry! 你访问的页没找到！</TITLE>
    ...
    <%--<META http-equiv=refresh content="5; url=http://www.liangliang.com/">--%>
...
<DIV align=center>
    <TABLE height=257 cellSpacing=0 cellPadding=0 width=306
           background="../statics/image/404.jpg" border=0>
        <TBODY>
        <TR>
                        ...
                        <TD>
                            <DIV align=center>
                                <TABLE cellSpacing=2 cellPadding=0 width="100%" align=center
                                    ...
                                    <TR>
                                        <TD height=22>
                                            <LI>请访问<A href="http://www.liang.com/"><FONT
                                                    color=#990000>良良的</FONT></A>首页</LI></TD></TR>
                                    <TR>
                                        <TD style="PADDING-RIGHT: 8px">
                                            <LI>5秒钟后自动跳转。</LI></TD></TR></TBODY></TABLE><BR></DIV></TD></TR></TBODY></TABLE>
                <P>　</P></TD></TR>
        <TR>
            <TD vAlign=bottom align=right><A href="http://www.zanpo.net/"><FONT
                    color=#ff0000>[由此返回主页]</FONT></A></TD></TR></TBODY></TABLE></DIV>
<SCRIPT src="../statics/image/mystat.htm"></SCRIPT>
</BODY></HTML>
